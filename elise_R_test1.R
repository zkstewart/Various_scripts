...
ggsave(file='quizcat_totals.pdf', g, width=15, height=10, units="in")
...
for (file in quizcat_files){
  ...
  #capture.output(as.data.frame(fit[1:5]), file = "quizcat_totals_stats.txt")
  i = i + 1
}
i = 1
...
write.csv(mainDF, file = "quizcat_totals_stats.csv")
