...
def create_mutmap_shell_script(comparisonDict, referenceFastaFile, outputFileName, threads=1, mem=5):
    '''
...
def main():
    ...
    create_mutmap_shell_script(comparisonDict, args.referenceFastaFile, args.outputFileName, args.threads)
