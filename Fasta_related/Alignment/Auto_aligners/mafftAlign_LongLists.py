...
# Specify format to use with this script
print('This script works with excel formatted rows and columns, where the first column is a gene name, followed by any number of columns alternating with transcript IDs followed by sequences. Make sure your file is formatted as such')
print('')
...
while True:
        if clipOrFasta == '1':
            ...
            muscle_cline = MafftCommandline(mafft_exe, input = unalignedFasta)
            ...
            for entry in newLineSplit:
                ...
                if mode == 1:
                    geneName = tempSplit[0]                                 # Takes first column out as gene name
                    for i in range(1, len(tempSplit), 2):
            ...
            # Create a temporary file to be aligned by MAFFT
                ...
                mafftOut = open(geneName + '.fasta', 'w')
